...
plugins=(colored-man-pages aws docker emoji git github jsontools sublime tmux npm python pip virtualenv brew cloudapp osx zsh-syntax-highlighting zsh-completions)

# User configuration

export DEFAULT_USER="chris"
export PATH="/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/git/bin:/Users/chris/go-tools/bin"
export GOPATH=$HOME/go-tools

# Auto-completion plugins (brew)
